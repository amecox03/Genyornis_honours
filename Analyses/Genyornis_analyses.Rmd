...
#for some reason the newxFW has returned a large value than confidence interval
lines(newxTW, conf_intervalTW [,2], col="blue", lty=2)
lines(newxTW, conf_intervalTW [,3], col="blue", lty=2)

#fill in area between regression line and confidence interval - very pretty but then you have to re-plot the points
polygon(c(rev(newxTW), newxTW), c(rev(conf_intervalTW [ ,3]), conf_intervalTW[ ,2]),density = 25, col = 'grey', border = NA)
...
#for some reason the newxFW has returned a large value than confidence interval
lines(newxTMTW, conf_intervalTMTW [,2], col="blue", lty=2)
lines(newxTMTW, conf_intervalTMTW [,3], col="blue", lty=2)

#fill in area between regression line and confidence interval - very pretty but then you have to re-plot the points
polygon(c(rev(newxTMTW), newxTMTW), c(rev(conf_intervalTMTW [ ,3]), conf_intervalTMTW[ ,2]),density = 25, col = 'grey', border = NA)
...
#text to data points
#text(data=data_plot, tmtM.L ~ tmtD.P, label=data$specimen.no)
...
Ternary_matrix <- na.omit (as.matrix (data_plot[,c ("fL", "tbL", "tmtL")]))
