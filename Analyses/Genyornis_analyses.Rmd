...
colours[which(data_plot$species == "modestus")] <- "#cc0000"
...
datanoD_plot <- cbind (data2_noD[,1:4], log (data2_noD[,5:17]))

#Also here setting up a vector of colours you can use to highlight _Genyornis_
#make a vector of just pink
colours <- rep("hotpink",nrow(data_plot2))
#make a vector where any species name that has Genyornis is assigned purple
colours[which(data_plot2$species == "newtoni")] <- "#33cc33"
colours[which(data_plot2$genus == "Illbandornis")] <- "#196619"
colours[which(data_plot2$species == "maximus")] <- "#ff0000"
colours[which(data_plot2$species == "modestus")] <- "#990000"
colours[which(data_plot2$species == "robustus")] <- "#ff6600"
colours[which(data_plot2$species == "novaezealandiae")] <- "#b34700"
colours[which(data_plot2$genus == "Pachyornis")] <- "#ffc299"
colours[which(data_plot2$genus == "Struthio")] <- "#191966"
colours[which(data_plot2$genus == "Dromaius")] <- "#3366ff"
colours[which(data_plot2$genus == "Casuarius")] <- "#3333cc"
...
```{r segerate data set with just the large flightless birds}
...
colours[which(largebirds_plot$species == "modestus")] <- "#cc0000"
...
#will likely be able to use the raw Hansford & Turvey (2018) measurements for Aepyornithiformes, as this method does not require individuals
